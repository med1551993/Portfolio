...
export const contact = [
  ...
  { id: 2, icon: <PhoneIphone />, text1: "0123456789", text2: "0345627891" },
  {
    id: 3,
    icon: <EmailOutlined />,
    text1: "email@email.com",
    text2: "email@email.com",
  },
];
export const social = [
  { id: 1, icon: <Facebook /> },
